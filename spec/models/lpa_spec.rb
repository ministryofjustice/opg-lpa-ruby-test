...
describe Lpa do
  ...
  describe "create" do
  	it "should post the full json" do
  		...
  		@lpa.save
			a_request(:post, "http://localhost:9292/api/lpas.json").with(:body => '{"donor":{"address":{"post_code":"E2 6BH"}},"attorneys":[{"address":{},"title":"Mrs"}],"replacement_attorneys":[],"title":"Mr"}').should have_been_made
  	end
  end
